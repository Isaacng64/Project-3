...
export default class GuitarString extends LightningElement {
  ...
  /* 
   * String class holds information on all frets in the string. Handles strum event and un-presses other frets when a fret in a string is pressed.
   */
  ...
  /* When one fret is pressed, 'handlePressed' deactivates all frets that are not pressed on a string. */
  handlePressed(event) {
